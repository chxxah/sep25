...
<body>
	...
	상영일
	<br><div id="date">${tcInfo.ms_sdate}</div>
	<br>
	<br> 상영시간
	<br><div id="time">${tcInfo.ms_stime} ~ ${tcInfo.ms_etime}</div>
	<br>
	<br> 좌석
	<br><div id="seat"> ${list}</div>
	...
	<button id="okay"
	        onclick="location.href='/ticketlist'">
	확인</button>
